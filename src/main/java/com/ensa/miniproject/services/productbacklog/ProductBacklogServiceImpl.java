...
public class ProductBacklogServiceImpl implements ProductBacklogService {
    ...
    public ProductBacklogDTO updateProductBacklog(ProductBacklogDTO productBacklogDTO) {
        ...
        if(productBacklogDTO.description() != null) {
            productBacklog.setDescription(productBacklogDTO.description());
        }
        if(productBacklogDTO.title() != null) {
            productBacklog.setTitle(productBacklogDTO.title());
        }
        if(productBacklogDTO.priority() != null) {
            productBacklog.setPriority(productBacklogDTO.priority());
        }
        if (productBacklogDTO.status() != null) {
            productBacklog.setStatus(productBacklogDTO.status());
        }
        if(productBacklogDTO.userStories() != null) {
            productBacklog.setUserStories(productBacklogDTO.userStories());
        }
